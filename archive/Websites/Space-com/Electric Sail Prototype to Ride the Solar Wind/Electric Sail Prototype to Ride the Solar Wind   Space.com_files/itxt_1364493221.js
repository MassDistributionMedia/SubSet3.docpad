...
{new $iTXT.data.Channel();$iTXT.data.Country.init($iTXT.glob.params.get("cc","en"));$iTXT.js.requiresContextualization=cbr.requiresContextualization;$iTXT.js.chunkKey=cbr.chunkKey;$iTXT.js.requiresAdverts=cbr.requiresAdverts;var isDraggable=$iTXT.glob.params.getBool("drag",1);var useMobile=$iTXT.core.Browser.isTargetedSmartphone($iTXT.glob.params.getBool("tt.force.mobile",false))&&$iTXT.glob.params.getBool("js.mob.chrome.on",false);if(undefined==$iTXT.ui.tt)
{if(useMobile)
...
{new $iTXT.itxt.Controller();}};$iTXT.js.loader["$iTXT.itxt.GoogleAnalytics"]=true;var _gaq=_gaq||[];$iTXT.itxt.GoogleAnalytics_Load=function()
...
{var evtObj=[this.trackerName+"."+name];if(_.isArray(data))
{evtObj=evtObj.concat(data);}
else
{evtObj.push(data);}
_gaq.push(evtObj);}
else
{this.initialGAQueue.push([name,data]);}},_pageHit:function(e)
...
{}},kickOffAdTypeTrackers:function()
...
{}}};$iTXT.data.GoogleAnalyticsController.init();};