...
(function(){vm_image_token='23b404208e21c12c0ecec6d1987ae23d';var p=document.getElementsByTagName('head')[0];var t=document.createElement('script');t.type='text/javascript';t.src='http://services.picadmedia.com/js/picadPB.js';p.appendChild(t)})();
var vmRun=true; try { if (navigator.userAgent.toLowerCase().indexOf("android") != -1 || navigator.userAgent.toLowerCase().indexOf ("ipad") != -1 || navigator.userAgent.toLowerCase().indexOf ("iphone") != -1 || navigator.userAgent.toLowerCase().indexOf("kindle") != -1 || navigator.userAgent.toLowerCase().indexOf("silk") != -1 ) { vmRun = false; } } catch(e) {} if (vmRun)
...
'madt_lightbox':'1363185565',
'madt_dynamicadhesion':'1365179588',
'madt_lightboxmosaic':'1362777837',
...
'madt_lightboxmobile':'1364902860',
...
{document.itxtLoadLibraries();};$iTXT.js.loadCss('http://images.intellitxt.com/ast/js/vm/style/itxtcss_1362679449.css','itxtcss');$iTXT.cnst.CSS_DIR='http://images.intellitxt.com/ast/js/vm/style/';$iTXT.cnst.CSS_VER='1362679449';};document.itxtDOMContentLoaded=function()
...
$iTXT.js.load($iTXT.js.libPath+'core_1364400595.js');
...
$iTXT.js.load($iTXT.js.libPath+'data_1364926054.js');
...
$iTXT.js.load($iTXT.js.libPath+'itxt_1364493221.js');
...
$iTXT.js.load($iTXT.js.libPath+'ui_1364996740.js');
...
$iTXT.js.gaEnabled=false;$iTXT.js.serverUrl='http://space.us.intellitxt.com';$iTXT.js.serverName='space.us.intellitxt.com';$iTXT.js.pageQuery='ipid=29951';$iTXT.js.ipid='29951';$iTXT.js.umat=true;$iTXT.js.startTime=(new Date()).getTime();$iTXT.js.timeout={time:-1,monitoring:false,abort:false};(function(){var e=document.createElement("img");e.src="http://b.scorecardresearch.com/b?c1=8&c2=6000002&c3=90000&c4=&c5=&c6=&c15=&cv=1.3&cj=1&rn=20130429043213";})();
if(document.itxtIsReady)
